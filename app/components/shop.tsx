  ...
  return (
    <div className="min-h-screen flex flex-col items-center gap-3 m-auto">
      ...
      <div className="min-h-screen flex flex-col items-center px-4 sm:px-6 lg:px-16 gap-10 sm:gap-20 m-auto max-w-[1440px] w-full">
        {/* Showing X results */}
        <div className="w-full flex flex-col sm:flex-row items-center sm:items-center justify-between mt-6 gap-3">
          <p className="text-sm text-gray-400">Showing all {filtered.length} results</p>
              ...
              <div className="mt-3 px-1">
                ...
                <div className="relative h-7 overflow-hidden">
                  <div className="absolute inset-0 flex items-center gap-2 transition-all duration-500 ease-in-out sm:group-hover:-translate-y-full sm:group-hover:opacity-0">
                    {product.onSale && <span className="text-sm text-gray-400 line-through">{product.originalPrice}</span>}
