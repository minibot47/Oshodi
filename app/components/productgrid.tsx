...
const products = [
  ...
  { id: 4, name: "Leather Jacket",        originalPrice: "80.00 $", salePrice: "60.00 $", onSale: true,  category: "Blazers", tag: "SALE", sku: "WOO-004", desc: "Make a statement with this bold pink blazer. Tailored to perfection, it pairs beautifully with both casual and formal outfits.", img: "/images/leatherjacket.webp" },
  ...
  { id: 7, name: "Long Neck Sweater",       originalPrice: null,       salePrice: "30.00 $", onSale: false, category: "Dresses", tag: null,    sku: "WOO-007", desc: "Breezy and bright, this summer dress is made for warm days and good vibes. Lightweight fabric with a flattering cut.", img: "/images/longnecksweater.webp" },
  { id: 8, name: "Manly Coat",      originalPrice: null,       salePrice: "22.00 $", onSale: false, category: "Tops",    tag: null,    sku: "WOO-008", desc: "An everyday casual blouse that goes with everything. Soft fabric, relaxed fit — effortlessly chic.", img: "/images/manlycoat.webp" },
  { id: 9, name: "Polka Dots Dress",        originalPrice: "95.00 $", salePrice: "75.00 $", onSale: true,  category: "Coats",   tag: "SALE", sku: "WOO-009", desc: "A timeless trench coat that never goes out of fashion. Structured, sophisticated, and built to last through every season.", img: "/images/polka.webp" },
];
