  ...
  return (
    ...
    <main className="min-h-screen flex flex-col gap-3 max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-10">
      ...
      <div className="mt-10 mb-32  ">
        <h2 className="text-lg sm:text-xl mb-5 text-[#556174] ">Brands</h2>
      ...
      <div className="mb-5 sm:mb-32">
        ...
        <div className="w-full flex flex-col lg:flex-row lg:items-stretch gap-4 lg:gap-0 h-auto lg:h-[556px] mt-1 sm:mt-16">
          <div className="w-full lg:w-[38%] h-[45vh] lg:h-full">
            ...
            <div className="w-full sm:w-[90%] h-[50%] flex flex-col gap-2 justify-end p-0  sm:p-3 ">
              <h2 className="w-full h-full text-[#556174] text-left flex items-end leading-7 font-thin">
              ...
              <h2 className="w-full h-full text-[#556174] text-left flex items-end leading-7 font-light">Explore our website and unveil the ultimate fusion of contemporary fashion, guiding you to discover and confidently embrace your perfect, modern style through our curated collection</h2>
            </div>
          </div>
