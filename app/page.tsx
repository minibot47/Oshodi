...
export default function Home() {
  ...
  return (
    ...
    <main className="min-h-screen flex flex-col gap-3 max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-10">
      <div className="relative w-full mt-[10]  sm:h-[60vh] lg:h-[584px] rounded-[16px] overflow-hidden flex flex-col items-center justify-center gap-8">
        <div
      ...
      <div className="mt-10 mb-32  ">
        ...
        <div className="w-full m-auto flex flex-wrap items-center justify-center gap-3 sm:gap-8">
      ...
      {/* OUR COLLECTION */}
      <div className="mb-36">
        <h1 className="lg sm:text-xl mb-5 text-gray-500 font-light">Our Collection</h1>
      ...
      {/* NEW ARRIVALS */}
      <div className="mb-40">
        <h1 className="text-lg sm:text-xl mb-5 text-gray-500 font-light">New Arrivals</h1>
      ...
      {/* TESTIMONIALS */}
      <div className="mb-36">
        <h2 className="text-lg sm:text-xl mb-5 text-gray-500 font-light">Testimonials</h2>
        <div className="mb-16">
