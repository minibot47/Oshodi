  ...
  return (
    ...
    <main className="min-h-screen flex flex-col gap-3 max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12">
      <div className="relative w-full mt-[6] h-[60vh] sm:h-[60vh] lg:h-[555px] rounded-[16px] overflow-hidden flex flex-col items-center justify-center gap-8">
        ...
        <h2 className="relative z-10 text-white  text-4xl sm:text-5xl lg:text-8xl w-full lg:w-[850px] text-center px-2">
      ...
      <div className="mt-10 mb-28  ">
        ...
        <div className="w-full px-2 m-auto flex flex-wrap items-center justify-between ">
          <img src="/brandicons/brand1.webp" alt="brand1" className="w-[40px] h-[35px] sm:w-[90px] sm:h-[70px]" />
          <img src="/brandicons/brand2.webp" alt="brand2" className="w-[40px] h-[35px] sm:w-[90px] sm:h-[70px]"/>
          <img src="/brandicons/brand3.webp" alt="brand3" className="w-[40px] h-[35px] sm:w-[90px] sm:h-[70px]"/>
          <img src="/brandicons/brand4.webp" alt="brand4" className="w-[40px] h-[35px] sm:w-[90px] sm:h-[70px]"/>
          <img src="/brandicons/brand5.webp" alt="brand5" className="w-[40px] h-[35px] sm:w-[90px] sm:h-[70px]"/>
          <img src="/brandicons/brand6.webp" alt="brand6" className="w-[40px] h-[35px] sm:w-[90px] sm:h-[70px]"/>
          <img src="/brandicons/brand7.webp" alt="brand7" className="w-[40px] h-[35px] hidden sm:flex sm:w-[90px] sm:h-[70px]"/>
          <img src="/brandicons/brand8.webp" alt="brand8" className="w-[40px] h-[35px] hidden sm:flex sm:w-[90px] sm:h-[70px]"/>
        </div>
      </div>
      ...
      <div className="mb-5 sm:mb-32">
        ...
        <div className="w-full flex flex-col lg:flex-row lg:items-stretch gap-5 lg:gap-0 h-auto lg:h-[556px] mt-1 sm:mt-10">
          <div className="w-full lg:w-[38%] h-[45vh] lg:h-full">
            ...
            <div className="w-full sm:w-[92%] h-[50%] flex flex-col gap-2 justify-end p-0  sm:p-3 ">
              <h2 className="w-full h-full text-[#556174] text-left flex items-end leading-6.5 font-thin">
              ...
              <h2 className="w-full h-full text-[#556174] text-left flex items-end leading-6.5 font-light">Explore our website and unveil the ultimate fusion of contemporary fashion, guiding you to discover and confidently embrace your perfect, modern style through our curated collection</h2>
            </div>
          </div>
          <div className="w-full lg:w-[62%] h-[30vh] lg:h-full rounded-[16px] overflow-hidden relative group">
            ...
            <div className="absolute inset-0 flex items-center justify-center z-10">
              <button
                ...
                className="flex items-center gap-3 bg-white/30 backdrop-blur-md  text-white text-sm font-semibold px-8 py-4 rounded-full hover:bg-white/40 transition-all duration-300"
              >
      ...
      {/* TESTIMONIALS */}
      <div className="mb-36">
        <h2 className="text-lg sm:text-xl mb-5 text-[#556174] ">Testimonials</h2>
        <div className="mb-16">
      ...
      {/* FLASHSALE */}
      <div className="relative w-full h-fit sm:h-[70vh] lg:h-[688px] rounded-[16px] mb-24 p-6 sm:p-14 overflow-hidden flex flex-col gap-10 items-start text-white">
        <div
