...
export default function Home() {
  ...
  const philosophyBg = "/images/elitebook.jpg";
  const collectionSummerBg = "/images/iphone16.jpg";
  const collectionSweatersBg = "/images/homeappliances.jpg";
  const flashSaleBg = "/images/sonycamera.jpg";
    ...
    <>
      <main className="min-h-screen flex flex-col gap-3 max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="relative w-full mt-[6] h-[60vh] sm:h-[60vh] lg:h-[555px] rounded-[16px] overflow-hidden flex flex-col items-center justify-center gap-8">
          <video autoPlay loop muted playsInline className="absolute inset-0 w-full h-full object-cover" src="/videos/maindemo.mp4" />
        ...
        <div className="mt-10 mb-28">
          ...
          <div className="w-full px-2 m-auto flex flex-wrap items-center justify-evenly gap-6">
            {["brand1","brand3","brand4","brand5","brand6","brand7","brand8"].map((brand, i) => (
              <img key={brand} src={`/brandicons/${brand}.png`} alt={brand}
                className={`object-contain w-[60px] h-[40px] sm:w-[100px] sm:h-[80px] lg:w-[130px] lg:h-[90px] ${i >= 6 ? "hidden lg:block" : ""}`}
              />
            ))}
          </div>
        </div>
        ...
        <div className="mb-5 sm:mb-32">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            ...
            <Link href="/shop" className="py-3 px-7 border-[0.1px] border-black rounded-full flex gap-2 items-center">
              See the Collection <img src="/icons/arrow.png" alt="Arrow" className="w-8 h-8" />
            </Link>
          </div>
            ...
            <div className="w-full lg:w-[38%] h-[45vh] lg:h-full">
              ...
              <div className="w-full sm:w-[92%] h-[50%] flex flex-col gap-2 justify-end items-end p-0 sm:p-3">
                <div className="flex flex-col gap-5">
                  ...
                  <h2 className="w-full text-[#556174] leading-6 text-left flex font-light">
                    Browse our store and find the perfect device for your home, your work, or your everyday life, backed by genuine warranties and delivered straight to your door.
                  </h2>
                </div>
              </div>
            </div>

            {/* Philosophy image + Watch Video */}
            <div className="w-full lg:w-[62%] h-[30vh] lg:h-full rounded-[16px] overflow-hidden relative group">
              <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url(${philosophyBg})` }} aria-hidden="true" />
              <div className="absolute inset-0 bg-black/20" aria-hidden="true" />
        ...
        <div className="mb-36">
          ...
          <div className="h-auto lg:h-[56vh] w-full rounded-[16px] gap-3 flex flex-col lg:flex-row">
            <div className="w-full lg:w-[37%] rounded-[16px] overflow-hidden relative flex flex-col items-start justify-end p-7 text-white">
              <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url(${collectionSummerBg})` }} aria-hidden="true" />
              <div className="absolute inset-0 bg-black/20" aria-hidden="true" />
              ...
              <Link href='/shop?category=Smartphones' className="cursor-pointer">
                <h2 className="relative z-10 flex gap-3 items-center bg-black text-white px-7 py-3 rounded-full mt-4">See Product →</h2>
              </Link>
            </div>
            <div className="w-full lg:w-[26%] rounded-[16px] flex flex-col gap-3">
              <div className="w-full h-[60%] rounded-[16px] overflow-hidden relative flex flex-col items-start justify-end p-7 text-white">
                <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: 'url("/images/macbook1.jpg")' }} aria-hidden="true" />
                <div className="absolute inset-0 bg-black/20" aria-hidden="true" />
            ...
            <div className="w-full lg:w-[37%] rounded-[16px] overflow-hidden relative flex flex-col items-start justify-end p-7 text-white">
              <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url(${collectionSweatersBg})` }} aria-hidden="true" />
              <div className="absolute inset-0 bg-black/20" aria-hidden="true" />
        ...
        <div className="mb-36">
          ...
          <div className="flex lg:flex-row flex-col justify-between items-start lg:items-center gap-5 mb-16">
            ...
            <Link href="/shop" className="py-3 px-8 border-[0.1px] border-black rounded-full flex gap-2 items-center">
              View All <img src="/icons/arrow.png" alt="Arrow" className="w-8 h-8" />
            </Link>
          </div>
          <GridSystem />
        </div>
      ...
      {/* FLASHSALE */}
      <div className="flex flex-col gap-3 max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12">
        <div className="relative w-full m-auto max-w-[1440px] h-fit sm:h-[70vh] lg:h-[688px] rounded-[16px] overflow-hidden mb-24 p-6 sm:p-14 flex flex-col gap-10 items-start text-white">
          <div className="absolute inset-0 bg-fill bg-center" style={{ backgroundImage: `url(${flashSaleBg})` }} aria-hidden="true" />
          <div className="absolute inset-0 bg-black/20" aria-hidden="true" />
      ...
      {/* Video modal — outside main so it's never clipped */}
      {videoOpen && (
        <div
        ...
        >
          <div
            className="relative w-full max-w-[1440px] rounded-2xl overflow-hidden"
